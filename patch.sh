...
perl -pi.bak -e 's/elem.max_width =/elem.max_width = Some\(Dimension::Pixels\(self.dimensions.pixel_width as f32 \/ num_tabs\)\); elem.min_width = Some\(Dimension::Pixels\(self.dimensions.pixel_width as f32 \/ num_tabs\)\);\/\//g' wezterm-gui/src/termwindow/render/fancy_tab_bar.rs
